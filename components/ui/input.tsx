  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-ring focus-visible:ring-blue-500/50 focus-visible:ring-[1px]",
        "aria-invalid:ring-destructive/20 bg-white  dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
        className
      )}
      {...props}
    />
